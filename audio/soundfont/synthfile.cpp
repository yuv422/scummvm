...
SynthInstr *SynthFile::AddInstr(uint32_t bank, uint32_t instrNum, Common::String name) {
...
SynthWave *SynthFile::AddWave(uint16_t formatTag, uint16_t channels, int samplesPerSec,
                              ...
                              uint32_t waveDataSize, unsigned char *waveData, Common::String name) {
...
SynthInstr::SynthInstr(uint32_t bank, uint32_t instrument, Common::String instrName)
